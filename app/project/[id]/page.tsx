...
const ProjectPage = async ({ params }: { params: { id: string } }) => {
  ...
  return (
    // <div className="container  bg-gradient-to-bl from-teal-900 via-black to-teal-900 z-50 grid h-full w-full bg-[#d9d9d9]/[.1] px-8 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2">
    // <div className="container z-20 grid h-full w-full bg-gradient-to-bl from-teal-900  via-slate-950  to-accent  px-8 pt-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2">
    <div className="container z-20 h-full w-full bg-gradient-to-bl from-teal-800 from-0% via-slate-950 via-50% to-accent to-100% pb-48 pt-6 sm:grid-cols-2 md:grid-cols-2 lg:grid lg:grid-cols-2">
      <ScrollToTop />
              ...
              <div className="flex w-6/12 flex-col max-md:ml-0 max-md:w-full">
                <div className="mt-1 flex grow flex-col text-xl font-extrabold text-white max-md:mt-10 max-md:max-w-full">
                  ...
                  <div className="mt-5 font-medium max-md:max-w-full">
                    {parseFloat(project?.targetAmount).toLocaleString("en-BO", {
                      style: "currency",
                      currency: "BOB",
                    })}
                  </div>
              ...
              <div className="ml-5 flex w-6/12 flex-col max-md:ml-0 max-md:w-full">
                <div className="flex flex-col text-xl font-extrabold text-white max-md:mt-10 max-md:max-w-full">
                  ...
                  <div className="mt-3.5 font-medium max-md:max-w-full">
                    {project?.qtyPortions - project?.availablePortions} unidades
                  </div>
                  <div className="mt-16 uppercase max-md:mt-10 max-md:max-w-full">
